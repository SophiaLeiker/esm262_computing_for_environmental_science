...
pmap_plot = ggplot(powerallr2, aes(car,power, fill=car))+
  geom_boxplot(width = 0.6, lwd = 0.8, color = c("sienna4", "mediumorchid4", "aquamarine4", "firebrick4"))+
  ggtitle("Method 1: Pmap - Range of Power Consumption for Each Car Type") +
...
ggarrange(method1_plot, pmap_plot)
...
forloop_plot = ggplot(powerallr3, aes(car,power, fill=car))+
  geom_boxplot(width = 0.6, lwd = 0.8, color = c("sienna4", "mediumorchid4", "aquamarine4", "firebrick4")) +
  ggtitle("Method 2: For Loop - Range of Power Consumption for Each Car Type") +
  labs(x = "Car", y = "Power (Watts)") +
  theme_minimal()+
  theme(legend.position = "none")
...
ggarrange(method1_plot, pmap_plot, forloop_plot, nrow=3)
...
ggarrange(pmap_plot, forloop_plot, nrow=2)
```

**Figure 1.** : [insert figure 1 text here]
